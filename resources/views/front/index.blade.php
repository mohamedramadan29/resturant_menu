...
@section('content')
    ...
    <div id="content">
        ...
        @endif
        <!-- Page Title -->
        <div class="hero_section page-title"
             style="background-image: url('{{asset('assets/front/uploads/slogan2.png')}}')">
            <div class="container">
                <div class="row">
                            ...
                            <div id="{{$category['slug']}}" class="menu-category">
                              ...
                              <span class="text-md mr-4">
                                  <span class="text-muted"></span> SAR <span
                                      data-product-base-price> {{number_format($product['price'],2)}} </span></span>
                                                        </div>
                                                        <div class="col-sm-6 text-sm-right mt-2 mt-sm-0">
                                                            <button
                                                                class="btn btn-secondary btn-sm add_to_cart"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="quantity_section">
                                                            ...
                                                            <div class="price_section">
                                                                <span id="total-price-{{$product['id']}}"
                                                                      class="product-modal-price">{{number_format($product['price'],2)}}  </span>
                                                                SAR
                                                            </div>
                                                        ...
                                                        <form id="addToCart_{{$product['id']}}" class="" method="post"
                                                            ...
                                                            <input type="hidden" name="price"
                                                                   value="{{ $product['price'] }}">
                                                            <div class="row align-items-center">
                                                                <button id="addtocartbutton_{{$product['id']}}" class="btn btn-secondary btn-block btn-lg">
                                                                      اضف الي السلة
                                                                </button>
                                                            </div>
                                                        </form>
