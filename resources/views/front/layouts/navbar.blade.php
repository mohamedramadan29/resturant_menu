...
<div id="body-wrapper" class="animsition">
                ...
                <div class="col-md-7">
                    ...
                    <nav class="module module-navigation right mr-4">
                        <ul id="nav-main" class="nav nav-main">
                            <li><a class="index_page" href="{{ route('index') }}">الرئيسية </a></li>
                            ...
                            <li><a class="account_page" href="{{ url('account') }}"> حسابي </a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-md-2">
    ...
    <nav id="panel-mobile">
        ...
        <div class="module module-social">
            ...
            <a href="#" class="icon icon-social icon-circle icon-sm icon-twitter"><i class="bi bi-instagram"></i>
            </a>
            <a href="#" class="icon icon-social icon-circle icon-sm icon-youtube"><i class="bi bi-tiktok"></i></a>
    ...
    <script>
        $(document).ready(function() {
            $('.index_page').on('click', function(e) {
                window.location.href = '{{ url('/') }}';
            });
            $('.account_page').on('click', function(e) {
