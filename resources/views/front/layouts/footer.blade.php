...
<footer id="footer" class="bg-dark dark">
    <div class="container">
        ...
        <div class="footer-first-row row">
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <form
                    ...
                    id="sign-up-form"
                    class="sign-up-form validate-form mb-5"
                    method="POST"
                >
                ...
                <a
                    href="#"
                    class="icon icon-social icon-circle icon-sm icon-google"
        ...
        <div class="footer-second-row">
              ...
              >Copyright Soup 2017©. Made with love by Suelo.</span
              >
        </div>
    </div>
